...
# install it ---------------------------------------------
pacstrap -c /mnt base base-devel dhcpcd grub nano xf86-video-intel xf86-video-nouveau xf86-video-ati xf86-input-synaptics xf86-input-mouse xf86-input-keyboard vim efibootmgr net-tools intel-ucode linux linux-headers linux-firmware mkinitcpio
# --------------------------------------------------------
